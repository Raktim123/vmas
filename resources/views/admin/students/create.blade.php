            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-4 shadow mb-4">
                        ...
                        <div class="card-body">
                            <fieldset>
                                <h4 class="fs-title mb-4">Personal Details</h4>
                                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card p-4 shadow mb-4">
                        <div class="card-body">
                            <fieldset>
                                <h4 class="fs-title mb-4">Academic Details</h4>
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="card p-4 shadow mb-4">
                        <div class="card-body">
                            <fieldset>
                                <h4 class="fs-title mb-4">Contact Details</h4>
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="card p-4 shadow mb-4">
                        <div class="card-body">
                            <fieldset>
                                <h4 class="fs-title mb-4">Transport</h4>
                                <div class="row justify-content-between align-items-end">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card p-4 border border-2 border-dark mb-4" id="car_details" style="display: none;">
                                            <div class="card-body">
                                                <h6 class="text-start">ID: <span id="vehicle_number" style="font-weight: bold; text-align: right;"></span></h6>
